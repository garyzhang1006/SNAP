...
**2026-09-19, second production 1B shard and the last one queued.** Shard s02 (`snap-new-k02-s02`) finished with 20 of 20 runs at 1B scored and none failed, on the same request-file hash, in 29,199 wall seconds. With s01, s02 and s04 that is 52 of the 75 runs at 1B, and the pilot's three c4 runs at 1B were scored earlier on the file before the CoQA regrouping. The twenty remaining runs (dolma1.7-no-flan seeds 4 and 5, dolma1.7-no-math-no-code, dolma1.7-no-reddit, falcon, falcon-with-cc, falcon-with-cc-top-10p and falcon-with-cc-top-20p) sit in shard s03. Its push at 18:45 EDT was refused with "Maximum weekly GPU quota of 30.00 hours reached", so s03 waits for the next quota window. The 1B analysis remains unrun and the reported test still reads 530M and 750M until s03 finishes, at which point k04 runs once at the full registered scope of 530M, 750M and 1B with the same rule and interval construction.
