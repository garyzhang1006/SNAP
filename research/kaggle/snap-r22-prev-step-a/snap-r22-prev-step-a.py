"""R22 part a: reduce every configuration at the checkpoint before its selected step.
...
RECIPES = ["falcon-with-cc-top-orig-10p", "falcon-with-cc-top-tulu-10p", "c4", "dclm-baseline", "dclm-baseline-25p-dolma1.7-75p"]
...
manifest = {"part": "a", "recipes": {}, "failures": {}}
for recipe in RECIPES:
    ...
    try:
        ...
        tar.unlink(missing_ok=True)
    (W / "prev_manifest_a.json").write_text(json.dumps(manifest, indent=1))
