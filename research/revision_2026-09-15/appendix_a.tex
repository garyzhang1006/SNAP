...
\begin{table}[h]
\centering
\label{tab:notation}\caption{Notation for the cross-half construction and its empirical diagnostics. The coefficient $\bar r_E$ uses covariance normalisation, which differs from mean correlation under unequal marginal variances.}
