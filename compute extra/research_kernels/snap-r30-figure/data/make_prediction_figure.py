...
# The width matches the ICLR text block of 5.5 inches so that \includegraphics[width=\linewidth]
# scales by exactly one. At the previous 7.0 inches LaTeX shrank everything to 0.786, which put the
# contrast labels on the page at 5.2pt, below \tiny. The aspect ratio is unchanged, so the figure
# still occupies the same 2.75 inches of vertical space it did before.
