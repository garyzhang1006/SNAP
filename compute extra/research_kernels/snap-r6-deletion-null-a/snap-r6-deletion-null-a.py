"""R6 precision run for the true-ratio-one accuracy null, at 8,000 replicates.
...
the two runs can be compared directly and pooled if they agree. Seed 20260941 keeps the draws distinct.
"""
...
(W / "r6_deletion_null_a.json").write_text(json.dumps(report, indent=1))
