"""R22 part d: reduce every configuration at the checkpoint before its selected step.
...
RECIPES = ["dolma1.7-no-code", "dolma1.7-no-flan", "dolma1.7-no-math-no-code", "dolma1.7-no-reddit", "falcon"]
...
manifest = {"part": "d", "recipes": {}, "failures": {}}
for recipe in RECIPES:
    ...
    try:
        ...
        tar.unlink(missing_ok=True)
    (W / "prev_manifest_d.json").write_text(json.dumps(manifest, indent=1))
