"""R6 precision run for the margin-like null, at 8,000 replicates.
...
the two runs can be compared directly and pooled if they agree. Seed 20260943 keeps the draws distinct.
"""
...
(W / "r6_deletion_null_margin_b.json").write_text(json.dumps(report, indent=1))
