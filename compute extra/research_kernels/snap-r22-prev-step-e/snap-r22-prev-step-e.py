"""R22 part e: reduce every configuration at the checkpoint before its selected step.
...
RECIPES = ["falcon-with-cc", "falcon-with-cc-top-10p", "falcon-with-cc-top-20p", "fineweb-edu", "fineweb-pro"]
...
manifest = {"part": "e", "recipes": {}, "failures": {}}
for recipe in RECIPES:
    ...
    try:
        ...
        tar.unlink(missing_ok=True)
    (W / "prev_manifest_e.json").write_text(json.dumps(manifest, indent=1))
