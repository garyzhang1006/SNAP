"""R20 part a: index the checkpoint steps in five DataDecide recipe tarballs.
...
for recipe in RECIPES:
    for attempt in range(1, 4):
        try:
            ...
            time.sleep(30)
    (W / "step_index_a.json").write_text(json.dumps(out, indent=1))
