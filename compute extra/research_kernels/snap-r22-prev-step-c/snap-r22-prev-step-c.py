"""R22 part c: reduce every configuration at the checkpoint before its selected step.
...
RECIPES = ["dclm-baseline-top-fw-3p", "dclm-baseline-top-fw2-7p", "dclm-baseline-top-fw3-7p", "dolma1.6++", "dolma1.7"]
...
manifest = {"part": "c", "recipes": {}, "failures": {}}
for recipe in RECIPES:
    ...
    try:
        ...
        tar.unlink(missing_ok=True)
    (W / "prev_manifest_c.json").write_text(json.dumps(manifest, indent=1))
