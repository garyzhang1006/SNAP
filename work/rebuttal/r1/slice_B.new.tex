...
A later cluster test-inversion interval covers 0.935 to 0.956 in a 10,000-replicate repeat of the same populations and gives \ci{1.095}{1.323} for margins and \ci{0.995}{1.162} for accuracy on the observed data. A residual-scaled wild interval covers 0.943 to 0.958 at 4,000 replicates and moves neither interval across one, but because we chose it after seeing four of the cells, we report the shipped interval throughout (Appendix~\ref{app:calibration}). Recipe influence on the margin estimate is concentrated, with a participation ratio of 3.08 across the 25 recipes and dolma1.7-no-math-no-code holding 0.520 of the squared influence, and removing that recipe moves the estimate by 0.037. With clusters on the five size bands instead of the 25 recipes, the margin interval runs 1.030 to 1.426 and excludes one, while the accuracy interval runs 0.961 to 1.184 and includes one (Appendix~\ref{app:supplementary}).
